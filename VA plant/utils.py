# -*- coding: utf-8 -*-
"""
Created on Mon Apr 26 14:45:12 2021
...
# The five classes of VA plants study
base_classes = ['Arrowhead', 'Duckweed', 'Grassy Mud Plaintain', 'Hydrilla', 'Watercress']
...
def predict_json(project, region, model, instances, version=None):
    ...
    Returns:
        Mapping[str: any]: dictionary of prediction results defined by the 
            model.
    """
    # Define the ML Engine service object
    ...
    # Define ML engine resource endpoint and input data
...
# Define a function to import an image and resize it to be able to be used with our model
